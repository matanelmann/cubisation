...
namespace CodeMonkey {
    ...
    public static class CMDebug {
        ...
        public static void TextPopupMouse(string text, float popupTime, int fontSize, Color color) {
            UtilsClass.CreateWorldTextPopup(text, UtilsClass.GetMouseWorldPositionZeroZ(), popupTime, fontSize, color);
        }

        // Creates a Text pop up at the world position
        public static void TextPopup(string text, Vector3 position, float popupTime, int fontSize, Color color) {
            UtilsClass.CreateWorldTextPopup(text, position, popupTime, fontSize, color);
        }
