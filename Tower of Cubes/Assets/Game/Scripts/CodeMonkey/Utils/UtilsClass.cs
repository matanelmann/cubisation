...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static void CreateWorldTextPopup(string text, Vector3 localPosition, float popupTime, int fontSize, Color color) {
            CreateWorldTextPopup(null, text, localPosition, fontSize, color, localPosition + new Vector3(0, 20), popupTime);
        }
